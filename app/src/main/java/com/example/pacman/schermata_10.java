...
public class schermata_10 extends AppCompatActivity {

    private Button schermata1;
    private Button schermata9;
    private Button schermata_11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //EdgeToEdge.enable(this);
        setContentView(R.layout.activity_schermata_10);
        ...
        schermata1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(schermata_10.this, schermata1.class);
        ...
        schermata9 = findViewById(R.id.BottoneAnnulla10);
        schermata9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(schermata_10.this, schermata9.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
            }
        });

        //codice per spostamento a schermata_10----------------------------------------------------
        schermata_11 = findViewById(R.id.BottoneConferma10);
        schermata_11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(schermata_10.this, schermata_11.class);
